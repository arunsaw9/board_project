...
class OtpcSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $comm->remarks()->saveMany([
            ...
            new Remark(['name' => 'Information', 'code' => 'C2']),
        ...
        $it->remarks()->saveMany([
            ...
            new Remark(['name' => 'Information', 'code' => 'IT2']),
        ...
        $contract->remarks()->saveMany([
            new Remark(['name' => 'Approval', 'code' => 'CM1']),
            new Remark(['name' => 'Information', 'code' => 'CM2']),
            new Remark(['name' => 'Noting', 'code' => 'CM3']),
        ]);
