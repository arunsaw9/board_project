                ...
                @csrf 
                    <div class="row">
                        <div class="col-12">
                            ...
                            <input type="number" name="priority" id="priority" value="{{ $agenda->priority }}" class="form-control">
                        </div>
                        <div class="col-6">
                        ...
                        @if( Auth::user()->hasRole('admin') )
                            ...
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary text-white" href="/board/agenda/{{ $agenda->id }}/edit" >Update</button>
