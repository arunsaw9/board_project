...
<div class="container mt-2">
    <div class="card shadow-sm">
        <div class="card-body">
            <h3 class="card-title text-primary"> <v-icon color="primary">mdi-pencil-outline</v-icon> Create Notification</h3>
            ...
            @csrf
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="title" id="title" rows="4" class="form-control">{{ $message }}</textarea>
